...
export const INDIA_LOCATIONS: IndiaLocation[] = [
  {
    ...
    cities: [
      ...
      { name: 'Rajahmundry', slug: 'rajahmundry' }, { name: 'Kurnool', slug: 'kurnool' },
      { name: 'Kadapa', slug: 'kadapa' }, { name: 'Anantapur', slug: 'anantapur' },
      { name: 'Vizianagaram', slug: 'vizianagaram' }, { name: 'Eluru', slug: 'eluru' },
      { name: 'Ongole', slug: 'ongole' }, { name: 'Srikakulam', slug: 'srikakulam' },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Lakhimpur', slug: 'lakhimpur' }, { name: 'Bongaigaon', slug: 'bongaigaon' },
      { name: 'Dhubri', slug: 'dhubri' }, { name: 'Karimganj', slug: 'karimganj' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Arrah', slug: 'arrah' }, { name: 'Begusarai', slug: 'begusarai' },
      { name: 'Katihar', slug: 'katihar' }, { name: 'Munger', slug: 'munger' },
      { name: 'Chhapra', slug: 'chhapra' }, { name: 'Bihar Sharif', slug: 'bihar-sharif' },
      { name: 'Saharsa', slug: 'saharsa' }, { name: 'Hajipur', slug: 'hajipur' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Jagdalpur', slug: 'jagdalpur' }, { name: 'Ambikapur', slug: 'ambikapur' },
      { name: 'Raigarh', slug: 'raigarh' }, { name: 'Chirmiri', slug: 'chirmiri' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Janakpuri', slug: 'janakpuri' }, { name: 'Pitampura', slug: 'pitampura' },
      { name: 'Saket', slug: 'saket' }, { name: 'Vasant Kunj', slug: 'vasant-kunj' },
      { name: 'Lajpat Nagar', slug: 'lajpat-nagar' }, { name: 'Shahdara', slug: 'shahdara' },
      { name: 'Greater Noida', slug: 'greater-noida' }, { name: 'Ghaziabad', slug: 'ghaziabad-dl' },
      { name: 'Narela', slug: 'narela' }, { name: 'Najafgarh', slug: 'najafgarh' },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Jamnagar', slug: 'jamnagar' }, { name: 'Junagadh', slug: 'junagadh' },
      { name: 'Anand', slug: 'anand' }, { name: 'Navsari', slug: 'navsari' },
      { name: 'Morbi', slug: 'morbi' }, { name: 'Surendranagar', slug: 'surendranagar' },
      { name: 'Mehsana', slug: 'mehsana' }, { name: 'Bharuch', slug: 'bharuch' },
      { name: 'Nadiad', slug: 'nadiad' }, { name: 'Porbandar', slug: 'porbandar' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Karnal', slug: 'karnal' }, { name: 'Sonipat', slug: 'sonipat' },
      { name: 'Yamunanagar', slug: 'yamunanagar' }, { name: 'Panchkula', slug: 'panchkula-hr' },
      { name: 'Bhiwani', slug: 'bhiwani' }, { name: 'Sirsa', slug: 'sirsa' },
      { name: 'Bahadurgarh', slug: 'bahadurgarh' }, { name: 'Rewari', slug: 'rewari' },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Deoghar', slug: 'deoghar' }, { name: 'Hazaribagh', slug: 'hazaribagh' },
      { name: 'Giridih', slug: 'giridih' }, { name: 'Ramgarh', slug: 'ramgarh' },
      { name: 'Phusro', slug: 'phusro' }, { name: 'Chaibasa', slug: 'chaibasa' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Davanagere', slug: 'davanagere' }, { name: 'Ballari', slug: 'ballari' },
      { name: 'Vijayapura', slug: 'vijayapura' }, { name: 'Shivamogga', slug: 'shivamogga' },
      { name: 'Tumakuru', slug: 'tumakuru' }, { name: 'Raichur', slug: 'raichur' },
      { name: 'Bidar', slug: 'bidar' }, { name: 'Hassan', slug: 'hassan' },
      { name: 'Udupi', slug: 'udupi' }, { name: 'Hosapete', slug: 'hosapete' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Palakkad', slug: 'palakkad' }, { name: 'Alappuzha', slug: 'alappuzha' },
      { name: 'Kottayam', slug: 'kottayam' }, { name: 'Malappuram', slug: 'malappuram' },
      { name: 'Kasaragod', slug: 'kasaragod' }, { name: 'Pathanamthitta', slug: 'pathanamthitta' },
      { name: 'Thalassery', slug: 'thalassery' }, { name: 'Thrippunithura', slug: 'thrippunithura' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Satna', slug: 'satna' }, { name: 'Rewa', slug: 'rewa' },
      { name: 'Dewas', slug: 'dewas' }, { name: 'Murwara', slug: 'murwara' },
      { name: 'Chhindwara', slug: 'chhindwara' }, { name: 'Ratlam', slug: 'ratlam' },
      { name: 'Burhanpur', slug: 'burhanpur' }, { name: 'Khandwa', slug: 'khandwa' },
      { name: 'Bhind', slug: 'bhind' }, { name: 'Shivpuri', slug: 'shivpuri' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Navi Mumbai', slug: 'navi-mumbai' }, { name: 'Pimpri-Chinchwad', slug: 'pimpri-chinchwad' },
      { name: 'Amravati', slug: 'amravati' }, { name: 'Sangli', slug: 'sangli' },
      { name: 'Malegaon', slug: 'malegaon' }, { name: 'Jalgaon', slug: 'jalgaon' },
      { name: 'Akola', slug: 'akola' }, { name: 'Latur', slug: 'latur' },
      { name: 'Dhule', slug: 'dhule' }, { name: 'Ahmednagar', slug: 'ahmednagar' },
      { name: 'Chandrapur', slug: 'chandrapur' }, { name: 'Panvel', slug: 'panvel' },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Balasore', slug: 'balasore' }, { name: 'Baripada', slug: 'baripada' },
      { name: 'Bhadrak', slug: 'bhadrak' }, { name: 'Jharsuguda', slug: 'jharsuguda' },
      { name: 'Jeypore', slug: 'jeypore' }, { name: 'Angul', slug: 'angul' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Hoshiarpur', slug: 'hoshiarpur' }, { name: 'Gurdaspur', slug: 'gurdaspur' },
      { name: 'Firozpur', slug: 'firozpur' }, { name: 'Phagwara', slug: 'phagwara' },
      { name: 'Sangrur', slug: 'sangrur' }, { name: 'Moga', slug: 'moga' },
      { name: 'Pathankot', slug: 'pathankot' }, { name: 'Barnala', slug: 'barnala' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Alwar', slug: 'alwar' }, { name: 'Bharatpur', slug: 'bharatpur' },
      { name: 'Sikar', slug: 'sikar' }, { name: 'Pali', slug: 'pali' },
      { name: 'Barmer', slug: 'barmer' }, { name: 'Sri Ganganagar', slug: 'sri-ganganagar' },
      { name: 'Hanumangarh', slug: 'hanumangarh' }, { name: 'Jhunjhunu', slug: 'jhunjhunu' },
      { name: 'Tonk', slug: 'tonk' }, { name: 'Chittorgarh', slug: 'chittorgarh' },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Tiruppur', slug: 'tiruppur' }, { name: 'Erode', slug: 'erode' },
      { name: 'Vellore', slug: 'vellore' }, { name: 'Thoothukudi', slug: 'thoothukudi' },
      { name: 'Thanjavur', slug: 'thanjavur' }, { name: 'Dindigul', slug: 'dindigul' },
      { name: 'Cuddalore', slug: 'cuddalore' }, { name: 'Kancheepuram', slug: 'kancheepuram' },
      { name: 'Hosur', slug: 'hosur' }, { name: 'Nagercoil', slug: 'nagercoil' },
      { name: 'Kumbakonam', slug: 'kumbakonam' }, { name: 'Karur', slug: 'karur' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Ramagundam', slug: 'ramagundam' }, { name: 'Mahbubnagar', slug: 'mahbubnagar' },
      { name: 'Nalgonda', slug: 'nalgonda' }, { name: 'Adilabad', slug: 'adilabad' },
      { name: 'Suryapet', slug: 'suryapet' }, { name: 'Miryalaguda', slug: 'miryalaguda' },
      { name: 'Mancherial', slug: 'mancherial' }, { name: 'Siddipet', slug: 'siddipet' },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Mathura', slug: 'mathura' }, { name: 'Bareilly', slug: 'bareilly' },
      { name: 'Aligarh', slug: 'aligarh' }, { name: 'Moradabad', slug: 'moradabad' },
      { name: 'Saharanpur', slug: 'saharanpur' }, { name: 'Gorakhpur', slug: 'gorakhpur' },
      { name: 'Firozabad', slug: 'firozabad' }, { name: 'Jhansi', slug: 'jhansi' },
      { name: 'Muzaffarnagar', slug: 'muzaffarnagar' }, { name: 'Bulandshahr', slug: 'bulandshahr' },
      { name: 'Rampur', slug: 'rampur' }, { name: 'Shahjahanpur', slug: 'shahjahanpur' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Rudrapur', slug: 'rudrapur' }, { name: 'Kashipur', slug: 'kashipur' },
      { name: 'Mussoorie', slug: 'mussoorie' }, { name: 'Pithoragarh', slug: 'pithoragarh' },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Malda', slug: 'malda' }, { name: 'Baharampur', slug: 'baharampur' },
      { name: 'Habra', slug: 'habra' }, { name: 'Kharagpur', slug: 'kharagpur' },
      { name: 'Shantipur', slug: 'shantipur' }, { name: 'Haldia', slug: 'haldia' },
      { name: 'Raiganj', slug: 'raiganj' }, { name: 'Jalpaiguri', slug: 'jalpaiguri' },
      { name: 'Krishnanagar', slug: 'krishnanagar' }, { name: 'Cooch Behar', slug: 'cooch-behar' },
    ],
  },
  {
